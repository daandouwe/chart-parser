...
## Speed
To speed up the CKY parsing, we use a (simple) [cythonized version](chart-parser/cky/_cky.px) that is _almost_ a numpy implementation.
We also provide a [numpy cky](chart-parser/cky/cky_numpy.py). To use this, add the flag `--use-numpy`.
